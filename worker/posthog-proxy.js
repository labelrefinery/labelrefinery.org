...
// from `dist/` with no Worker in the path. Byte-for-byte the same proxy
// magmalake.org runs, itself ported 1:1 from the Rust one in mojoshelf
// (crates/shelf-worker/src/lib.rs, `posthog_proxy`) -- keep the three in
// step rather than letting each site drift its own copy.
